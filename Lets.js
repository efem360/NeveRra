...
function addLanguages() {
	...
	//window.top.$('#language').append("<option value='ko'>한국어</option>");
	//window.top.$('#language').append("<option value='ro'>� усский</option>");
	...
	//window.top.$('#language').append("<option value='tr'>Türkçe</option>");
	...
	//window.top.$('#language').append("<option value='sl'>Slovenščina</option>");
	//window.top.$('#language').append("<option value='lt'>Lietuvių</option>");
	...
	//window.top.$('#language').append("<option value='th'>� าษาไทย</option>");
}
